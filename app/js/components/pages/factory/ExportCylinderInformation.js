                    ...
                    <div className="modal-content">
                        ...
                        <div className="modal-body">
                            <Form ref={c => {
                                ...
                                <footer className="card-footer text-center" /*onClick={this.reloadPopup}*/>
                                    <button
                                        disabled={(typeof this.state.listProducts === "undefined" || this.state.listProducts.length === 0)}
                                        className="btn btn-primary" 
                                        onClick={(event) => {
                                            this.props.getUserByType_ExportCell()
                                        ...
                                        type="submit" 
                                        data-toggle="modal"
                                        data-target="#export-driver-type-cylinder">{this.props.t('NEXT')}
                                    </button>
                                    <button onClick={(event) => this.handleFileUpload(event, true)}
                                            className="btn btn-secondary" type="reset"
                                            data-dismiss="modal"
                                            style={{marginLeft: "10px"}}
                                            /*onClick={this.reloadPopup}*/>{this.props.t('CLOSE')}
                                    </button>
                                </footer>
                            </Form>
...
export default withNamespaces()( ExportCylinderInformation);
