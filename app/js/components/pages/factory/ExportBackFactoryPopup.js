                ...
                <div className="modal-dialog modal-lg">
                    <div className="modal-content">
                        <div className="modal-header">
                            <h5 className="modal-title">Xuất Bình Về Thương Nhân Sở Hữu - Bước 1 - Nhập File</h5>
                            ...
                            <Form ref={c => {
                                ...
                                <footer className="card-footer text-center">
                                    <button
                                        ...
                                        className="btn btn-primary" onClick={()=>{ const modal = $("#export-modal-back-factory");
                                        modal.modal('hide');}} type="submit" data-toggle="modal"
                                            data-target="#export-driver-back-factory">{this.props.t('NEXT')}</button>
...
export default withNamespaces()(ExportBackFactoryPopup) ;
