...
import {AUTOCREATECYLYNDER} from "./../../../config/config";
        ...
        if (isCheck) {
            ...
            fileReader.onload = async function (event) {
                ...
                if (resultSearch.status === 200) {
                    ...
                    // console.log("list acc",cylinders_list);
                            ...
                            <Form ref={c => {
                                ...
                                <div className="card-body custom-scroll-table">
                                    <div className="row">
                                       ...
                                       <button onClick={this.onAutoCreateCylinder}>{this.props.t('AUTO_CREATE')}</button>
                                ...
                                <footer className="card-footer text-center">
                                    <button
                                        ...
                                        data-target="#export-driver">{this.props.t('NEXT')}
                                    </button>
...
export default withNamespaces()(ExportFactoryPopup) ;
